...
export const CreateGoalSchema = z.discriminatedUnion("goalType", [
    ...
    baseGoalSchema.extend({
        ...
        targetCents: z.string({ message: "Adicione um valor objetivo" }).min(1, "O valor é obrigatório"),
    ...
    baseGoalSchema.extend({
        ...
        gearId: z.string(),
        targetQuantity: z.number({ message: "Adicione uma quantidade" }).min(1, "A quantidade é obrigatória"),
...
export type CreateGoalDataWithMoneyInCents = Omit<CreateGoalDataType, "targetCents"> & {
