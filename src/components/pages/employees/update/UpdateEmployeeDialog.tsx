...
export function UpdateEmployeeDialog({
    ...
    return (
        <Dialog
            ...
            onOpenChange={ (status) => handleToggleUpdateEmployeeDialog(status, selectedEmployee) }
        >
            <DialogContent
            ...
            >
                <DialogTitle className="text-3xl font-bold">Edite o funcionário:</DialogTitle>
                <div className="space-y-6">

                    <UpdateEmployeeForm selectedEmployee={ selectedEmployee } />

                    <DialogFooter>
                        <Button variant="outline" onClick={ () => handleToggleUpdateEmployeeDialog(false, selectedEmployee) }>
            Cancelar
                        </Button>
