...
export function TrainingPaymentMethodDialog({
  ...
  const hasChanged = useMemo(() => {
    ...
    const isSame =
      ...
      isCourtesy === (selectedTraining.isCourtesy || false) &&
      wasRefunded === (selectedTraining.wasRefunded || false) &&
      cancellationFee ===
        centsToString(selectedTraining.cancellationFee || 0) &&
  ...
  useEffect(() => {
    if (selectedTraining && isTrainingPaymentMethodDialogOpen && payerType) {
      ...
      setIsCourtesy(selectedTraining.isCourtesy || false);
      setWasRefunded(selectedTraining.wasRefunded || false);
      setCancellationFee(centsToString(selectedTraining.cancellationFee || 0));
