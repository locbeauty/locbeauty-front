...
//             const response = await fetch(`http://localhost:3333/api/bookings/customer?customerId=${selectedCustomer?.customerId}`, {
//                 credentials: "include",
//             });
...
//                             <Card key={ booking.bookingId } className="">
...
//                                                 <span>
//                                                     {minutesToHHMM(booking.startHourInMinutes)} - {minutesToHHMM((booking.startHourInMinutes + booking.totalDurationInMinutes))} ({booking.totalDurationInMinutes / 60}h)
//                                                 </span>
//                                             </div>
...
//                                                 <p className="text-muted-foreground mt-1">
//                                                     {booking.address.street.streetName}, {booking.address.neighborhood.neighborhoodName} - {booking.address.city.cityName}/{booking.address.state.UF}
