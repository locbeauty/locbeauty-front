...
import { CalendarIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, XCircle } from "lucide-react";
...
import { CustomDayPicker } from "./day-picker";
            ...
            <PopoverContent className="w-auto p-2">
                <div className="flex items-center justify-between">
                    <div className="text-md font-bold ms-2 flex items-center cursor-pointer">
                        ...
                        <Button variant="ghost" className="p-0 ml-2" onClick={ () => setMonthYearPicker(monthYearPicker ? false : "year") }>
